...
class HasteMap extends _events2.default {
  ...
  build() {
    if (!this._buildPromise) {
      ...
      then(hasteMap => {
        ...
        const moduleMap = new _module_map2.default({
  ...
  readModuleMap() {
    ...
    return new _module_map2.default({
  ...
  _crawl(hasteMap) {
    ...
    const crawl =
    canUseWatchman && this._options.useWatchman ? _watchman2.default : _node2.default;
    ...
    const emitChange = () => {
      if (eventsQueue.length) {
        ...
        this.emit('change', {
          ...
          moduleMap: new _module_map2.default({
            duplicates: hasteMap.duplicates,
            map: hasteMap.map,
            mocks: hasteMap.mocks }) });
